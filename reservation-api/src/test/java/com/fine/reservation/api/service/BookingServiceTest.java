...
class BookingServiceTest {
    ...
    void createBookings_WithReservationNo_ShouldUpdateReservationStatusAndCreateBookings() {
        ...
        BookingEntity b1 = BookingEntity.builder()
                .bookingNo(101L)
                .machineNo(1)
                .build();
        BookingEntity b2 = BookingEntity.builder()
                .bookingNo(102L)
                .machineNo(2)
                .build();
        ...
        verify(notificationService, times(2))
                .sendBookingConfirmation(any(BookingEntity.class));
        verify(pushService, times(2))
                .sendBookingNotification(any(BookingEntity.class));
        verify(webSocketService, times(2))
                .broadcastBookingUpdate(any(BookingEntity.class));
    ...
    void createBookings_WithoutReservationNo_ShouldOnlyCreateBookings() {
        ...
        BookingEntity b = BookingEntity.builder()
                ...
                .machineNo(3)
                .build();
        when(bookingRepository.save(any(BookingEntity.class))).thenReturn(b);
